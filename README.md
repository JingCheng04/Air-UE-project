...
- Nav2/DWB、`pointcloud_to_laserscan` 和 TF 相关 ROS 2 包，用于 UAV 导航和 LiDAR 避障。
- Python 3.12 虚拟环境，主要包含 `cosysairsim`、`msgpack-rpc-python`、`numpy`、`pynput`；MPC demo 还需要 coni-mpc/ACADO 及 YOLOE 所需的 Python 依赖。
